...
- (IBAction)postToTwitter:(id)sender
{
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
    {
        ...
        [tweetSheet setInitialText:@"I am using the "App_Name@" app, download it free from the AppStore!"];
...
- (IBAction)postToFacebook:(id)sender
{
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook])
    {
        ...
        [facebookSheet setInitialText:@"I am using the "App_Name@" app, download it free from the AppStore!"];
...
- (IBAction)shareByEmail:(id)sender
{
    ...
    [emailBody appendString:@"<p>I am using the "App_Name@" app, download it free from the AppStore!</p> <p>"Apple_App_URL@"</p>"];
...
- (IBAction)shareBySMS:(id)sender
{
    if ([MFMessageComposeViewController canSendText])
    {
        ...
        controller.body = @"I am using the "App_Name@" app, download it free from the AppStore! \n \n "Apple_App_URL@"";
