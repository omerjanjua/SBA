...
-(void)setupView
{
    if ([[UserDefault objectForKey:Status_Bar_Color] isEqualToString:@"Light"])
    {
        ...
        [_enquiryFormButton setImage:[UIImage imageNamed:@"enquiry-form-button-selected"] forState:UIControlStateNormal];
        [_enquiryFormButton setImage:[UIImage imageNamed:@"enquiry-form-button-selected"] forState:UIControlStateHighlighted];
        [_contactDetailsButton setImage:[UIImage imageNamed:@"contact-details-button"] forState:UIControlStateNormal];
    }
    if ([[UserDefault objectForKey:Status_Bar_Color] isEqualToString:@"Dark"])
    {
        ...
        [_enquiryFormButton setImage:[UIImage imageNamed:@"enquiry-form-button-selected-black"] forState:UIControlStateNormal];
        [_enquiryFormButton setImage:[UIImage imageNamed:@"enquiry-form-button-selected-black"] forState:UIControlStateHighlighted];
        [_contactDetailsButton setImage:[UIImage imageNamed:@"contact-details-button-black"] forState:UIControlStateNormal];
    }
    ...
    [_contactDetailsButton setImage:[UIImage imageNamed:@"contact-details-button-gray"] forState:UIControlStateHighlighted];
