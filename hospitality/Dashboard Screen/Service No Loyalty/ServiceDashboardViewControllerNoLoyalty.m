//
//  ServiceDashboardViewControllerNoLoyalty.m
//  hospitality
//
...
#import "ServiceDashboardViewControllerNoLoyalty.h"
...
@interface ServiceDashboardViewControllerNoLoyalty ()
...
@implementation ServiceDashboardViewControllerNoLoyalty
...
- (IBAction)dashboardButton1:(id)sender
{
    ServicesViewController *controller = [[ServicesViewController alloc] init];
