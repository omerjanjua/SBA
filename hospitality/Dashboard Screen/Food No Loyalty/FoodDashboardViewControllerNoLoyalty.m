//
//  FoodDashboardViewControllerNoLoyalty.m
//  hospitality
//
...
#import "FoodDashboardViewControllerNoLoyalty.h"
...
@interface FoodDashboardViewControllerNoLoyalty ()
...
@implementation FoodDashboardViewControllerNoLoyalty
...
- (IBAction)dashboardButton1:(id)sender
{
    MenuTypeOfMealViewController *controller = [[MenuTypeOfMealViewController alloc] init];
...
- (IBAction)dashboardButton3:(id)sender
{
    BookingFormViewController *controller = [[BookingFormViewController alloc] init];
    [self.navigationController pushViewController:controller animated:NO];
}
