...
@interface OffersSharingViewController ()

@end

@implementation OffersSharingViewController
...
- (IBAction)postToTwitter:(id)sender
{
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
    {
        ...
        [tweetSheet setInitialText:[NSString stringWithFormat:@"%@ - I am using the "App_Name@" app, download it free from the AppStore!", self.offersTitle]];
...
- (IBAction)postToFacebook:(id)sender
{
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook])
    {
        ...
        [facebookSheet setInitialText:[NSString stringWithFormat:@"%@ - I am using the "App_Name@" app, download it free from the AppStore!", self.offersTitle]];
...
- (IBAction)shareByEmail:(id)sender
{
    ...
    [emailBody appendString:[NSString stringWithFormat:@"<p>%@</p> <p>I am using the "App_Name@" app, download it free from the AppStore!</p> <p>"Apple_App_URL@"</p>", self.offersTitle]];
